...
Always remove the newline character from fgets input using item[strlen(item) - 1] = '\0'; to prevent formatting issues.

This program can be extended to handle multiple items, taxes, or discounts in the future.